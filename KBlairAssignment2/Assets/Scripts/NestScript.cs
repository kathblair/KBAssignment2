...
public class NestScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        SetAccelText();
        //micText.text = Microphone.devices.ToString();
        db = 20 * Mathf.Log10(Mathf.Abs(MicInput.MicLoudness));
        //micText.text = "g: " + gyroRot.ToString();
        micText.text = "c: " + compassval.ToString();
        //SetMicText();
    ...
    void SetAccelText()
    {
        //accelText.text = "a: " + gyroRot.ToString();
        accelText.text = Input.deviceOrientation.ToString();
    }
